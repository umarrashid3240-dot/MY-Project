...
// import SubNavbar from "../Components/SubNavbar"; // ✅ Added

// const SneakerDetails = () => {
//   const { id } = useParams();

//   // Find sneaker by id
//   const sneaker = sneakersProducts.find((item) => item.id === parseInt(id));
...
//   const [mainImage, setMainImage] = useState(sneaker.images[0]);
...
//             {sneaker.description ||
//               "Premium sneakers built for comfort, performance, and street style."}
//           </p>
    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="py-10 px-6 lg:px-20 flex flex-col lg:flex-row items-center gap-10">
        ...
        <div className="flex-1 bg-white rounded-2xl shadow-lg border border-green-300 p-8 mb-60">
          ...
          {/* Add to Cart Button */}
          <button
            onClick={() => addToCart({ ...sneaker, size: selectedSize }, 1)}
