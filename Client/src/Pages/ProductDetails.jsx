...
// import { products as JoggerProducts } from "./products";
// // Jogger data
...
//   const { id } = useParams();
//   const product = JoggerProducts.find((item) => item.id === parseInt(id));
...
//     <div className="min-h-screen bg-gray-100 py-10 px-6 lg:px-20 flex flex-col lg:flex-row items-center gap-10">
...
//       <div className="flex-1 bg-white rounded-2xl shadow-lg border border-green-300 p-8 mb-60">
//         <h1 className="text-3xl font-bold text-green-700 mb-4">
//           {product.name}
//         </h1>
//         <p className="text-gray-700 mb-6 leading-relaxed">
//           {product.description ||
//             "Stylish joggers designed for comfort and active lifestyle."}
//         </p>
...
//         {/* Sizes */}
//         <div className="mb-8">
//           <h4 className="text-gray-800 font-semibold mb-3">Available Sizes:</h4>
...
import React, { useState } from "react";
import { useParams } from "react-router-dom";
import { products as JoggerProducts } from "./products"; // Jogger data
import SearchBar from "../Components/SearchBar";
import SubNavbar from "../Components/SubNavbar";
